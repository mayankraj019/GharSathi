...
export function HeroSection() {
  ...
  // Interactive Match Showcase Cycle
  useEffect(() => {
  ...
  return (
    <section
      ...
      className="relative pt-32 pb-24 md:pt-40 md:pb-32 lg:pt-44 lg:pb-36 bg-white overflow-hidden"
    >
      ...
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[650px] h-[650px] bg-blue-500/[0.04] rounded-full blur-3xl pointer-events-none animate-pulse-glow" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-start text-left">
            ...
            <div className="space-y-4 text-base sm:text-lg text-slate-600 leading-relaxed max-w-2xl mb-8 font-normal">
              <p className="text-slate-900 font-semibold text-lg sm:text-xl">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full sm:w-auto mb-12">
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2 px-7 py-4 text-base font-semibold text-slate-700 hover:text-slate-900 bg-slate-50/80 hover:bg-slate-100 border border-slate-200 rounded-2xl transition-all duration-200 hover:-translate-y-0.5 cursor-pointer"
              >
                Learn More
              </button>
            </div>
          ...
          <div className="lg:col-span-5 flex items-center justify-center">
            <div
              ...
              className="relative w-full max-w-md lg:max-w-none animate-float-slow"
            >
              {/* Soft Ambient Outer Glow */}
              <div className="absolute -inset-1 bg-gradient-to-r from-blue-600/15 to-indigo-600/15 rounded-[32px] blur-2xl opacity-80 pointer-events-none" />

              {/* Glassmorphism Card */}
              <div className="relative backdrop-blur-xl bg-white/85 border border-slate-200/80 rounded-[28px] p-6 sm:p-7 shadow-[0_25px_60px_rgba(15,23,42,0.08)]">
                ...
                <div className="flex items-center justify-between pb-4 border-b border-slate-100 mb-5">
                  ...
                  <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-blue-50 text-[11px] font-semibold text-blue-700 border border-blue-200/50">
                ...
                >
                  <div className="p-4 rounded-2xl bg-gradient-to-br from-slate-900 to-slate-800 text-white border border-slate-800 shadow-md relative overflow-hidden">
                  ...
                  {step >= 3 && (
                    <div className="mt-3 flex items-center justify-center gap-2 p-2.5 rounded-xl bg-gradient-to-r from-emerald-600 to-teal-600 text-white text-xs font-bold shadow-md">
