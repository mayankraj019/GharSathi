...
export function LegalModal({ type, onClose }: LegalModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-200">
      {/* Modal Container */}
      <div
        className="bg-white dark:bg-slate-900 rounded-2xl border border-gray-200 dark:border-slate-800 shadow-2xl w-full max-w-3xl max-h-[85vh] flex flex-col overflow-hidden animate-in zoom-in-95 duration-200"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-5 border-b border-gray-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-950/50">
          ...
          <button
            onClick={onClose}
            className="p-2 rounded-lg text-gray-400 dark:text-slate-400 hover:text-gray-700 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-slate-800 transition-colors cursor-pointer"
        ...
        {/* Content Body */}
        <div className="p-6 sm:p-8 overflow-y-auto space-y-6 text-sm text-gray-600 dark:text-slate-300 leading-relaxed font-normal">
          {type === "privacy" && (
            <>
              <section>
                ...
                <ul className="list-disc pl-5 mt-2 space-y-1 text-gray-600 dark:text-slate-300">
                  <li>Full Name</li>
              ...
              <section>
                <h4 className="text-base font-bold text-gray-900 dark:text-white mb-2">3. Data Sharing &amp; Anti-Spam Guarantee</h4>
                <p>
              ...
              <section>
                <h4 className="text-base font-bold text-gray-900 dark:text-white mb-2">5. Contact &amp; Grievances</h4>
                <p>
                  For any privacy inquiries or request to remove your data, please contact our privacy compliance team at{" "}
                  <a href="mailto:supportgharsathi@gmail.com" className="text-blue-600 dark:text-blue-400 font-semibold underline">
          ...
          {type === "terms" && (
            <>
              <section>
                <h4 className="text-base font-bold text-gray-900 dark:text-white mb-2">1. Scope of Service</h4>
                <p>
              ...
              <section>
                <h4 className="text-base font-bold text-gray-900 dark:text-white mb-2">2. User Responsibilities</h4>
                <p>
              ...
              <section>
                <h4 className="text-base font-bold text-gray-900 dark:text-white mb-2">3. Zero Tenant Platform Fee</h4>
                <p>
              ...
              <section>
                <h4 className="text-base font-bold text-gray-900 dark:text-white mb-2">4. Broker Interactions &amp; Agreements</h4>
                <p>
          ...
          {type === "guidelines" && (
            <>
              <section>
                <h4 className="text-base font-bold text-gray-900 dark:text-white mb-2">1. Partner Verification Standards</h4>
                <p>
              ...
              <section>
                <h4 className="text-base font-bold text-gray-900 dark:text-white mb-2">2. Strict Anti-Spam &amp; Privacy Rule</h4>
                <p>
              ...
              <section>
                <h4 className="text-base font-bold text-gray-900 dark:text-white mb-2">3. Fast Response Expectation</h4>
                <p>
              ...
              <section>
                <h4 className="text-base font-bold text-gray-900 dark:text-white mb-2">4. Quality Assurance &amp; Blacklisting</h4>
                <p>
        ...
        {/* Footer Actions */}
        <div className="p-4 sm:p-6 border-t border-gray-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-950/50 flex justify-end">
          <button
            onClick={onClose}
