...
export function SuccessView({ onReset, customerName }: SuccessViewProps) {
  return (
    <div className="bg-white border border-gray-200/90 rounded-2xl p-8 sm:p-12 text-center max-w-2xl mx-auto shadow-card animate-in fade-in zoom-in-95 duration-300">
      ...
      <p className="text-base sm:text-lg text-gray-600 font-normal leading-relaxed mb-8 max-w-lg mx-auto">
      ...
      <div className="bg-slate-50 border border-gray-200 rounded-xl p-5 mb-8 flex items-center justify-center gap-3">
      ...
      <button
        onClick={onReset}
        className="inline-flex items-center justify-center gap-2 px-6 py-3 text-sm font-semibold text-white bg-blue-600 hover:bg-blue-700 active:bg-blue-800 rounded-xl transition-all shadow-soft"
      >
